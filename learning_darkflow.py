...
options = {"model": "./cfg/yolo.cfg", "load": "./cfg/bin/yolo.weights", "threshold": 0.4}
tfnet = TFNet(options)
...
new_write_boundingboxes(results, imgcv, './predictions/result.png')

os.system("cp ./predictions/result.png ./predictions/result.png")
